...
public:
    ...
    // Orca: pylon injection — resolves pylon_injection_filament (0 → solid_infill).
    unsigned int pylon_filament(const PrintObjectConfig &object_config, const PrintRegion &region) const;
